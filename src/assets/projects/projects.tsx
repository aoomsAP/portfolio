...
export const projects: Project[] = [
    {
        ...
        challenges: ["semantic html","grid & flex in css","basic js"],
    ...
    },
    {
        ...
        challenges: ["sessions and cookies","working in group"],
    ...
    },
    {
        ...
        images: [
            {
                ...
                description: "Homepage with random country spotlight",
                // bulletClass: "",
            },
            {
                ...
                description: "Overview page with filters & a flipped flag image",
                // bulletClass: "",
            },
            {
                ...
                description: "Detail page in dark mode",
                // bulletClass: "",
            },
        ],
        ...
        challenges: ["reusable components","property drilling"],
