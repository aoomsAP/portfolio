...
export const projects: IProject[] = [
...

    {
        ...
        summary_en: <>With two fellow students, I participated in the <a href="https://www.vlaamseprogrammeerwedstrijd.be" target="_blank">Flemish Programming Contest</a> edition of 2024.</>,
        summary_nl: <>Met twee medestudenten nam ik deel aan de 2024 editie van de <a href="https://www.vlaamseprogrammeerwedstrijd.be" target="_blank">Vlaamse Programmeerwedstrijd</a>.</>,
        description_en: <>With two fellow students, I participated in the <a href="https://www.vlaamseprogrammeerwedstrijd.be" target="_blank">Flemish Programming Contest</a> edition of 2024. Our team came in 10th, but we were first amongst the graduate students in our category. Preparing for the competition was half the fun, so we solved questions from previous editions both individually and as a team, which can be browsed in the Github link below.</>,
        description_nl: <>Met twee medestudenten nam ik deel aan de 2024 editie van de <a href="https://www.vlaamseprogrammeerwedstrijd.be" target="_blank">Vlaamse Programmeerwedstrijd</a>. Ons team behaalde de 10de plaats, maar we waren de eerste graduaatstudenten in onze categorie. Oefenenen voor de wedstrijd was even leuk als deelnemen, dus hebben we zowel individueel als in team enkele opgaves van vorige edities uitgewerkt, die geraadpleegd kunnen worden in de Github link hieronder.</>,
...

    {
        ...
        demo: "https://www.jcsandokanmechelen.be/",
    },
