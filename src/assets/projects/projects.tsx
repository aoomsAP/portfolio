...
export const projects: IProject[] = [
...

    {
        ...
        summary_nl: <>Een API over Landen, Orkesten en Muzikanten, met ASP.NET Core zowel als MVC als Minimal API, en een lokale MySQL database via Entity Framework.</>,
